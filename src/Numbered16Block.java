...
public class Numbered16Block extends NumberedBlock
{
 
    /**
     * Constructor for objects of class Numbered16Block
     */
    public Numbered16Block() //Setzt Bild je nach übergebenem Parameter
    {
        setNumberImage(16);
