...
public class Numbered8Block extends NumberedBlock
{
 
    /**
     * Constructor for objects of class Numbered8Block
     */
    public Numbered8Block() //Setzt Bild je nach übergebenem Parameter
    {
        setNumberImage(8);
