...
public class Numbered4Block extends NumberedBlock
{
 
    /**
     * Constructor for objects of class Numbered4Block
     */
    public Numbered4Block() //Setzt Bild je nach übergebenem Parameter
    {
        setNumberImage(4);
